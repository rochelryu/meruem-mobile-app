  ...
  Future getNewPin() async {
    try {
      ...
      setState(() {
        ...
        if (pin.length == 0) {
          message = "Créer un mot de passe pour securiser toutes vos transactions";
        } else {
          message = "Veuillez entrer votre mot de passe pour finaliser la transaction";
        }
      });
    } catch (e) {
      print("Erreur $e");
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage("assets/images/logo_avec_fond.png"),
                          fit: BoxFit.contain)),
                ),
                Padding(
                  ...
                  return Card(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                            child: Text(keyTouch[index].toString(), style: kBodyText1))),
                      ),
                    );
                } else if (index == 9) {
